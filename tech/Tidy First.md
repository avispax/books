...
これによって私たちはトレードオフを迫られる。いわゆるゴルディロックスのジレンマだ*1。何のコストを比較検討すれば、バッチあたりの整頓が少なすぎるのか、多すぎるのか、いくつくらいならちょうどよいのかを判断できるだろうか?(図18-2)
バッチあたりの整頓の量を増やした場合に上がるコストを図18‐3に示す。
*1 訳注:3つの選択肢があると、人間は無意識のうちに真ん中の選択肢を選んでしまう傾向のこと。
